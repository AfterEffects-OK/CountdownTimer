...
操作画面とタイマー表示を分けたい場合に便利です。（例: 配信でタイマー画面のみを視聴者に見せる）

1.  コントロールパネルの一番下にある「タイマーを別ウィンドウで表示」ボタンを押します。
2.  新しいウィンドウ（またはタブ）が開き、タイマー表示部分だけが表示されます。
...
- **データ保存**:
  - 遅延時間とプリセット設定は、ブラウザの `localStorage` に保存されます。
- **タブ間同期**:
